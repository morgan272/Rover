...
MarsRover is written in C# and compiled as a .net Core 2.1 app - you will need to download and install the runtime from the following location: https://dotnet.microsoft.com/download if you do not already have it.
